    ...
    <div class="container">
      ...
      <nav id="nav-menu-container">
        ...
        <li><a href="offreemploi.php">Offre d'emploi</a></li>
          ...
          <li><a href="categories.php">Formation</a></li>
...
<div class="section-header">
  <h2>Clients</h2>
  <p>Plus besoin de vous deplacer pour chercher du travail, grace à ECC Trouvez l'emploi qui vous convient en tout simplicité et rapidité. Découvez ci-dessous la liste des entreprises qui recrutent.</p>
</div>
