...
<body id="body">
  ...
  <header id="header">
    <div class="container">
      ...
      <div id="logo" class="pull-left">
        <h1><a href="index.php"><img src="img/logo-lg.png"  title="" /></h1>
      ...
      <nav id="nav-menu-container">
        ...
        <li><a href="#about">A propos</a></li>
          ...
          <li ><div  >
            <button class="btn-login-signup"><a href="login.php" class="btn-login" >Connexion</a></button>
            <button class="btn-login-signup"><a href="signup.php" class="btn-signup" >Inscription</a></button>
          </div></li>
        </ul>
  ...
  <section id="intro">
    ...
    <div class="intro-content">
      <h2>Ensemble vers<br><span> l'excellence !</span></h2>
...
<div class="owl-carousel testimonials-carousel">
  ...
  <div class="testimonial-item">
    <p>
      ...
      Grâce à ECC, j'ai trouvé mon poste actuel dans une entreprise technologique innovante après seulement trois entretiens.
      <img src="img/quote-sign-right.png" class="quote-sign-right" alt="">
    </p>
    <img src="img/testimonial-1.jpg" class="testimonial-img" alt="">
    <h3>Marc</h3>
    <h4>ingénieur en logiciel</h4>
  </div>

  <div class="testimonial-item">
    <p>
      <img src="img/quote-sign-left.png" class="quote-sign-left" alt="">
      ECC m'a aidé à décrocher un poste parfaitement adapté à mon expérience en vente internationale.
      <img src="img/quote-sign-right.png" class="quote-sign-right" alt="">
    </p>
  ...
  <div class="testimonial-item">
    <p>
      <img src="img/quote-sign-left.png" class="quote-sign-left" alt="">
      ecc m'a connecté à une startup dynamique où j'ai pu rejoindre leur équipe RH et participer à leur expansion.
      <img src="img/quote-sign-right.png" class="quote-sign-right" alt="">
    </p>
    <img src="img/testimonial-3.jpg" class="testimonial-img" alt="">
    <h3>Sophie</h3>
    <h4>spécialiste RH</h4>
  </div>

  <div class="testimonial-item">
    <p>
      <img src="img/quote-sign-left.png" class="quote-sign-left" alt="">
      Un postulat spontané sur ECC et quelques jours plus tard, je dirigeais des projets chez une agence de marketing numérique. 
      <img src="img/quote-sign-right.png" class="quote-sign-right" alt="">
    </p>
  ...
  <div class="testimonial-item">
    <p>
      <img src="img/quote-sign-left.png" class="quote-sign-left" alt="">
      J'ai trouvé mon défi tant recherché sur ECC, entamant rapidement un rôle passionnant dans une nouvelle entreprise.
      <img src="img/quote-sign-right.png" class="quote-sign-right" alt="">
    </p>
    <img src="img/testimonial-5.jpg" class="testimonial-img" alt="">
    <h3>Nora</h3>
    <h4>Directrice de communication</h4>
  </div>
    ...
    <div class="row contact-info">
      ...
      <div class="col-md-4">
        <div class="contact-email">
          ...
          <h3>Email</h3>
          <p><a href="mailto:ECC@example.com">ECC@example.com</a></p>
        </div>
      </div>
