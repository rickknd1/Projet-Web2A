...
?>
<?php
function afficherOffresStage($offres) {
    require_once '../../Controller/CandidaturestageC.php';
    $offreController = new candidaturestageC();
    foreach ($offres as $offre) {
        ...
        echo "<p><strong>Type de staget:</strong> {$offre['type_stage']}</p>";
        echo "<p><strong>duree:</strong> {$offre['duree']}</p>";
        ...
        $candidature_existe = $offreController->candidaturestageExistsForOffre($offre['id'],$_SESSION['id']);
        ...
        if (!$candidature_existe) {
          if($offre['nombre_place']==0){
            ...
            echo "<h3><p style='text-decoration: underline;'><a href='AddCandstage.php?id={$offre['id']}' class='btn2'>Postuler</a></p></h3>";
          }
        } else {
          $statut_candidature = $offreController->getStatutCandidaturestageByOffreId($offre['id']);
        ...
        echo "</div>";
        echo "<br>"; // Ajouter un saut de ligne entre chaque offre de stage
    }
}
?>
<!DOCTYPE html>
    ...
    <div class="container">
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <li class="#"><a href="offreemploi.php">Offre d'emploi</a></li>
          <li class="menu-active"><a href="offrestage.php">Stage</a></li>
...
<!-- affichage des offres de stages -->
<section id="offres" class="offres-section">
    <div class="container">
      <br><br></br></br>
      <h2 style="font-size: 34px #8e0000; margin-bottom: 40px;">Liste des Offres de stages:</h2>
      <?php 
          include '../../Controller/Offre_stageC.php';
          $offreController = new Offres_stageC();
          $listeOffres = $offreController->listOffrestage();
          afficherOffresStage($listeOffres); 
      ?>
    </div>
  </section>
<!-- fin de l'affichage des offres de stage -->
