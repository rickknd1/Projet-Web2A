...
$liste = $offreController->listOffrestage();
session_start();
			...
			<div class="user-info-dropdown">
				...
				<a class="dropdown-toggle" href="#" role="button" data-toggle="dropdown">
					...
					<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
						...
						<a class="dropdown-item" href="../frontoffice/index.php"><i class="dw dw-logout"></i> Log Out</a>
					</div>
				</div>
			</div>
	...
	<div class="main-container">
		<div class="pd-ltr-20 xs-pd-20-10">
						...
						<nav aria-label="breadcrumb" role="navigation">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">
									<span style="color:red;">Offre de stage </span>
			...
			<div class="card-box mb-30">
				<div class="pd-20">
					<h4 class="text-blue h4"><span style="color:red;">Offre de stage </span></h4>

				</div>
				<div class="pb-20">
					<table class="data-table table stripe hover nowrap">
						<div class="dt-buttons btn-group flex-wrap"> 
						<a href="AddOfrstage.php" class="btn btn-secondary buttons-copy buttons-html5" tabindex="0" aria-controls="DataTables_Table_2" type="button">
								<span>ADD</span>
							</a>
							<a href="listCandstage.php" class="btn btn-secondary buttons-copy buttons-html5" tabindex="0" aria-controls="DataTables_Table_2" type="button">
						...
						<tbody>
							<?php foreach($liste as $offre) { ?>
								...
								<?php
								$style = Offres_stageC::styleContentBackOffice($offre['description']);
								...
								<tr>
									...
									<td>
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
												<a href="UpdateStage.php?id=<?= $offre['id']; ?>" class="dropdown-item">
  						 						 <i class="dw dw-edit2"></i> Modifier
												</a>
												<a href="Deletestage.php?id=<?= $offre['id']; ?>" onclick="return confirm('Are you sure you want to delete this offer?');" class="dropdown-item">
