...
<body>
	...
	<div class="main-container">
		<div class="pd-ltr-20 xs-pd-20-10">
			...
			<form action="" method="POST" id="formP" onsubmit="return(valideform());">
				<table border="1" align="center">
					...
					<tr>
						...
						<td><input type="text" name="titre" id="titre" maxlength="20">
						...
						<td>
							<select name="categorie" id="categorie">
								<?php foreach ($categories as $categorie) : ?>
									<option value="<?php echo $categorie['id_categorie']; ?>"> <?php echo $categorie['nom_categorie'] . " | " . $categorie['niveau']; ?></option>
								<?php endforeach; ?>
							</select>
						</td>
					</tr>
