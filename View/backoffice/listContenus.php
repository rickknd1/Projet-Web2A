	...
	<div class="main-container">
		<div class="pd-ltr-20 xs-pd-20-10">
			...
			<div class="card-box mb-30">
				<div class="pd-20">
					<h4 class="text-blue h4">Cours</h4>

				</div>
				<div class="pb-20">
					<table class="data-table table stripe hover nowrap">
						<div class="dt-buttons btn-group flex-wrap">
							<a href="AddContenu.php" class="btn btn-secondary buttons-copy buttons-html5" tabindex="0" aria-controls="DataTables_Table_2" type="button">
								<span>ADD</span>
							</a>
							<a href="listCategorie.php" class="btn btn-secondary buttons-copy buttons-html5" tabindex="0" aria-controls="DataTables_Table_2" type="button">
						...
						<tbody>
							<?php foreach ($list as $Contenu) : ?>
								<tr>
									...
									<td><a href="<?= $Contenu['fichier']; ?>" download>Download</a></td> <!-- Lien téléchargeable -->
									<td>
										<?php if (!empty($Contenu['video'])) : ?>
											<video width="320" height="240" controls> <!-- Balise vidéo -->
												<source src="<?= $Contenu['video']; ?>" type="video/mp4">
												Your browser does not support the video tag.
											</video>
										<?php endif; ?>
									</td>
									<td><?= $Contenu['categorie']; ?></td>
									<td><img src="<?= $Contenu['image_path']; ?>" alt="Image de Contenu"></td>
									<td align="center">
										<form method="POST" action="updateContenu.php">
											<input type="submit" name="update" value="Update">
											<input type="hidden" value="<?= $Contenu['id_contenu']; ?>" name="id_contenu">
										</form>
									</td>
									<td>
										<a href="deleteContenu.php?id_contenu=<?= $Contenu['id_contenu']; ?>">Delete</a>
									</td>
								</tr>
							<?php endforeach; ?>
						</tbody>
