	...
	<div class="main-container">
		<div class="pd-ltr-20 xs-pd-20-10">
					...
					<div class="col-md-6 col-sm-12">
						...
						<nav aria-label="breadcrumb" role="navigation">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item">
									<a href="listEvents.php">Evènements</a>
								</li>
			...
			if (isset($_POST['id_event'])) {
				$event = $EventC->getEventById($_POST['id_event']);
			?>
				...
				<form action="" method="POST" onsubmit="return(valideform());">
					<table border="1" align="center">
						<tr>
							...
							<td><input type="text" name="id_event" id="id_event" value="<?php echo $event->getIdEvent(); ?>" maxlength="20"></td>
						</tr>
						<tr>
							<td>
							...
							<td><input type="text" name="Nomcours" id="Nomcours" value="<?php echo $event->getNomCours(); ?>" maxlength="20">
								<span id="NomcoursMessage" style="color: red;"></span>
							</td>
						</tr>
						<tr>
							<td>
								<label for="Datecours">Nom cours :
								</label>
							</td>
							<td><input type="date" name="Datecours" id="Datecours" value="<?php echo $event->getDateCours(); ?>">
							</td>
						</tr>
						<tr>
							<td></td>
		...
		<script>
			...
			document.getElementById("Nomcours").addEventListener("input", function() {
				var text = this.value;
				if (verif_alphanumerique(text)) {
					this.style.backgroundColor = "#ffffff";
					document.getElementById("NomcoursMessage").textContent = "";
				} else {
					this.style.backgroundColor = "red";
					document.getElementById("NomcoursMessage").textContent = "Nom cours invalide";
				}
			});
			...
			function valideform() {
				...
				if (!verif_alphanumerique(Nomcategorie)) {
					document.getElementById("Nomcours").style.backgroundColor = "red";
					NomcategorieMessage.textContent = "Nom cours invalide";
					return false;
				} else {
					document.getElementById("Nomcours").style.backgroundColor = "";
