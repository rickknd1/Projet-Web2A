...
if (!isset($_SESSION['admin_name'])) {
	header('location:C:\xampp\htdocs\2A34\Ecc_gestion_user\View\frontoffice\login.php');
}
		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="card-box mb-30">
					<div class="pd-20">
						<h4 class="text-blue h4" style="color: red;">Utilisateurs</h4>
					</div>
					<div class="pb-20">
						<table class="table hover multiple-select-row data-table-export nowrap">
							<thead>
								<tr>
									<th class="table-plus datatable-nosort">Civilite</th>
									<th>nom</th>
									<th>Email</th>
									<th>Experience</th>
									<th>Gouvernorat</th>
							...
							<tbody>
								<?php foreach ($liste as $user) { ?>
									<tr>
										<td class="table-plus"><?= $user['civilite']; ?></td>
										<td><?= $user['nom']; ?></td>
										<td><?= $user['email']; ?></td>
										...
										<td>
											<div class="dropdown">
												...
												<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
													<a class="dropdown-item" href="infosusers.php?email=<?= $user['id']; ?>"><i class="dw dw-eye" style="color: red;"></i> Détails</a>
													<a class="dropdown-item" href="_UptdateUser.php?email=<?= $user['id']; ?>"><i class="dw dw-edit2" style="color: red;"></i> Modifier</a>
													<button type="button" class="dropdown-item" onclick="showPopup('<?= htmlspecialchars($user['email']); ?>')"><i class="dw dw-delete-3" style="color: red;"></i> Supprimer</button>
												</div>
											</div>

											<!-- Custom Popup for confirmation -->
											<div id="deleteConfirmPopup" style="display:none; position: fixed; left: 50%; top: 50%; transform: translate(-50%, -50%); background: white; border: 1px solid #ccc; padding: 20px; z-index: 100;">
