...
function countRowsInTable($tableName) {
    $db = config::getConnexion(); // Récupérer l'objet PDO
			...
			<div class="sidebar-menu">
				...
				<li class="dropdown">
						<a href="javascript:;" class="dropdown-toggle">
							<span class="micon bi bi-file-earmark-text"></span><span class="mtext">Pages</span>
						</a>
						<ul class="submenu">
	...
	<div class="main-container">
		<div class="xs-pd-20-10 pd-ltr-20">
			<div class="title pb-20">
				<h2 class="h3 mb-0">Aperçu du site web</h2>
			</div>
					...
					<div class="card-box height-100-p widget-style3">
						<div class="d-flex flex-wrap">
							<div class="widget-data">
								...
								<div class="font-14 text-secondary weight-500">revenues formation</div>
							</div>
							<div class="widget-icon">
							...
							<tr>
								<td class="table-plus">
									<div class="name-avatar d-flex align-items-center">
										...
										<!-- Username -->
										<div class="txt">
											<div class="weight-600"><?= $user['nom']; ?></div>
										</div>
									</div>
								</td>
