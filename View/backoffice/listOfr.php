...
$liste = $offreController->listOffres();
session_start();
	...
	<div class="main-container">
		<div class="pd-ltr-20 xs-pd-20-10">
					...
					<div class="col-md-6 col-sm-12">
						...
						<nav aria-label="breadcrumb" role="navigation">
							<ol class="breadcrumb">
								...
								<span style="color:red;">Offre D'Emplois</span>
								</li>
							</ol>
						</nav>
					</div>
			...
			<div class="card-box mb-30">
				<div class="pd-20">
					<h4 class="text-blue h4"><span style="color:red;">Offre D'Emplois</span></h4>

				</div>
				<div class="pb-20">
					<table class="data-table table stripe hover nowrap">
						<div class="dt-buttons btn-group flex-wrap"> 
						<a href="AddOfr.php" class="btn btn-secondary buttons-copy buttons-html5" tabindex="0" aria-controls="DataTables_Table_2" type="button">
								<span>ADD</span>
							</a>
							<a href="listCand.php" class="btn btn-secondary buttons-copy buttons-html5" tabindex="0" aria-controls="DataTables_Table_2" type="button">
						...
						<tbody>
							<?php foreach($liste as $offre) { ?>
								<tr>
								<?php
								$style = OffreEmpC::styleContentBackOffice($offre['description']);
								...
								<tr>
									...
									<td>
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
												<a href="UpdateOfr.php?id=<?= $offre['id']; ?>" class="dropdown-item">
  						 						 <i class="dw dw-edit2"></i> Modifier
												</a>
												<a href="DeleteOfr.php?id=<?= $offre['id']; ?>" onclick="return confirm('Are you sure you want to delete this offer?');" class="dropdown-item">
