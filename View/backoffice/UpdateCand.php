...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	$candidatureController->updateCandidatureStatut($candidature_id, $new_statut);
	$offre_id = $candidatureController->getOffreIdByCandidatureId($candidature_id);
	// Utilisation de la fonction pour envoyer un e-mail
	$destinatinataire =$_POST['email'];
	

	$sujet = "Reponse candidature";
	...
	if ($new_statut == 'Acceptée') {
		...
		$offreEmpC = new OffreEmpC();
		$offreEmpC->decrementPlaces($offre_id);
	...
	<div class="main-container">
		<div class="pd-ltr-20 xs-pd-20-10">
			...
			<section class="form-container">
				...
				<form action="UpdateCand.php" method="POST">
					<input type="hidden" name="candidature_id" value="<?= $_GET['candidature_id']; ?>">
