<?php
require_once "../../validationstage.php"; 
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit']) && $valide) {
    ...
    // Création de l'objet Offrestage
    ...
    $offreController->addOffrestage($offre);
...
<body>
	...
	<div class="main-container">
		<div class="pd-ltr-20 xs-pd-20-10">
					...
					<div class="col-md-6 col-sm-12">
						...
						<nav aria-label="breadcrumb" role="navigation">
							<ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item">
									<a href="listOfrstage.php">Offre De stages</a>
								</li>
			...
			<form action="AddOfrstage.php" method="POST" enctype="multipart/form-data">
        <table>
            <tr>
            ...
            <tr>
                ...
                <td><input type="text" id="duree" name="duree" required></td>
            </tr>
            <tr>
    ...
    <div class="btn">
        <a href="listOfrstage.php" class="btn1">Return</a>
    </div>
