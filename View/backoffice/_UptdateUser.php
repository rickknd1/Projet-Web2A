...
if (isset($_POST["submit"])) {
	if (
		isset($_POST["civilite"]) && isset($_POST["prenom"]) && isset($_POST["nom"]) && isset($_POST["email"]) &&
		isset($_POST["experience"]) && isset($_POST["nivetude"]) && isset($_POST["typeformation"]) &&
		isset($_POST["gouvernorat"]) && isset($_POST["telephone"]) && isset($_POST["ville"]) && isset($_POST["cv"])
	) {

		if (
			!empty($_POST["civilite"]) && !empty($_POST["prenom"]) && !empty($_POST["nom"]) && !empty($_POST["email"]) &&
			!empty($_POST["experience"]) && !empty($_POST["nivetude"]) && !empty($_POST["typeformation"]) &&
			!empty($_POST["gouvernorat"]) && !empty($_POST["telephone"]) && !empty($_POST["ville"]) && !empty($_POST["cv"])
		) {

			// Sanitize user input (consider using prepared statements for database queries)
			$email = htmlspecialchars($_POST['email']);
			$civilite = htmlspecialchars($_POST['civilite']);
			$prenom = htmlspecialchars($_POST['prenom']);
			$nom = htmlspecialchars($_POST['nom']);
			$experience = htmlspecialchars($_POST['experience']);
			$nivetude = htmlspecialchars($_POST['nivetude']);
			$typeformation = htmlspecialchars($_POST['typeformation']);
			$gouvernorat = htmlspecialchars($_POST['gouvernorat']);
			$telephone = htmlspecialchars($_POST['telephone']);
			$ville = htmlspecialchars($_POST['ville']);
			$cv = htmlspecialchars($_POST['cv']);

			$user = new users($email, $civilite, $prenom, $nom, $experience, $nivetude, $typeformation, $gouvernorat, $telephone, $ville, $cv);

			// Update user information
			$userC->updateUser($user, $email);

			// Redirect to a different page after form submission
			header('Location: busers.php');
			exit(); // Always exit after redirection to prevent further script execution
		} else {
