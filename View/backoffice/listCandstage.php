...
$listeCandidaturestage = $candidatureController->listcandidaturestages();
?>
<html>
	...
	<div class="main-container">
		<div class="pd-ltr-20 xs-pd-20-10">
					...
					<div class="col-md-6 col-sm-12">
						...
						<nav aria-label="breadcrumb" role="navigation">
							<ol class="breadcrumb">
								...
								<a href="listStage.php">Offre de stage</a>
								</li>
                                <li class="breadcrumb-item active" aria-current="page">
									<span style="color: red;">Candidatures</span>
								</li>
							</ol>
						</nav>
					</div>
			...
			<div class="card-box mb-30">
				<div class="pd-20">
					<h4 class="text-blue h4"><span style="color: red;">Candidatures</span></h4>

				</div>
				<div class="pb-20">
					<table class="data-table table stripe hover nowrap">
						<div class="dt-buttons btn-group flex-wrap"> 
							<a href="listStage.php" class="btn btn-secondary buttons-copy buttons-html5" tabindex="0" aria-controls="DataTables_Table_2" type="button">
						...
						<tbody>
							<?php foreach($listeCandidaturestage as $candidature) { ?>
								
								<?php
								$style = CandidaturestageC::styleContentBackOffice($candidature['lettre_motivation']);
								$style2 = CandidaturestageC::styleContentBackOffice($candidature['cv_path']);
								?>
								
                                <td><?= $candidature['candidatureStage_id']; ?></td>
                                ...
                                <td><?= $candidature['statut']; ?></td>
									...
									<td>
										<div class="dropdown">
                                            ...
                                            <a href="UpdateCandstage.php?candidaturestage_id=<?php echo($candidature['candidatureStage_id']) ?>" class="dropdown-item">
  						 						 <i class="dw dw-edit2"></i> Affecter
												</a>
                                                <?php } ?>
												<a href="DeleteCandstage.php?candidaturestage_id=<?php echo ($candidature['candidatureStage_id']) ?>" onclick="return confirm('Are you sure you want to delete?');" class="dropdown-item">
