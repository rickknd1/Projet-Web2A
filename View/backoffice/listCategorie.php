	...
	<div class="main-container">
		<div class="pd-ltr-20 xs-pd-20-10">
			...
			<div class="card-box mb-30">
				<div class="pd-20">
					<h4 class="text-blue h4">Catégories</h4>
						...
						<tbody>
							...
							?>
									<tr>
										...
										<td><img src="<?= $Categorie['image_path']; ?>" alt="Image de catégorie"></td>
										<td align="center">
										...
										<td>
											<a href="deleteCategorie.php?id_categorie=<?= $Categorie['id_categorie']; ?>">Supprimer</a>
										</td>
									</tr>
							<?php
								}
