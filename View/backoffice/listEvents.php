	...
	<div class="main-container">
		<div class="pd-ltr-20 xs-pd-20-10">
			...
			<div class="card-box mb-30">
				<div class="pd-20">
					<h4 class="text-blue h4">Evènements</h4>
				...
				<div class="pb-20">
					...
					<table class="data-table table stripe hover nowrap">
						<div class="dt-buttons btn-group flex-wrap">
							<a href="AddCategorie.php" class="btn btn-secondary buttons-copy buttons-html5" tabindex="0" aria-controls="DataTables_Table_2" type="button">
								<span>ADD</span>
							</a>
							<a href="listCours.php" class="btn btn-secondary buttons-copy buttons-html5" tabindex="0" aria-controls="DataTables_Table_2" type="button">
								<span>COURS</span>
							</a>
						...
						<tbody>
							<?php foreach ($events as $event) : ?>
								<tr>
									...
									<td><?= $event->getNomCours(); ?></td>
									<td><?= $event->getDateCours(); ?></td>
									<td align="center">
										<form method="POST" action="updateEvent.php">
											<input type="submit" name="update" value="Modifier">
											<input type="hidden" value="<?= $event->getIdEvent(); ?>" name="id_event">
										</form>
									</td>
									<td>
										<a href="deleteEvent.php?id_event=<?= $event->getIdEvent(); ?>">Supprimer</a>
									</td>
								</tr>
							<?php endforeach; ?>
						</tbody>
