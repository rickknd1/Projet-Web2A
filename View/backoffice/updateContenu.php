...
if (
	...
	if (
		...
		$ContenuC->updateContenu($Contenu, $_POST["id_contenu"]);
...
<body>
	...
	<div class="main-container">
		<div class="pd-ltr-20 xs-pd-20-10">
			...
			<div id_contenu="error">
				<?php echo $error; ?>
			</div>

			<?php
			if (isset($_POST['id_contenu'])) {
				$Contenu = $ContenuC->showContenu($_POST['id_contenu']);
			...
			?>
				...
				<form action="" method="POST" onsubmit="return(valideform());">
					<table>
						<tr>
							<td>
								<label for="id_contenu">id_contenu :
								</label>
							</td>
							<td><input type="text" name="id_contenu" id="id_contenu" value="<?php echo $Contenu['id_contenu']; ?>" maxlength="20"></td>
						</tr>
						<tr>
							<td>
							...
							<td><input type="text" name="titre" id="titre" value="<?php echo $Contenu['titre']; ?>" maxlength="20">
								<span id="titreMessage" style="color: red;"></span>
							</td>
						</tr>
						<tr>
							<td>
							...
							<td><input type="text" name="description" id="description" value="<?php echo $Contenu['description']; ?>" maxlength="20"></td>
						</tr>
						<tr>
							<td>
							...
							<td>
								<input type="file" name="fichier" value="<?php echo $Contenu['fichier']; ?>" id="fichier">
							</td>
						</tr>
						<tr>
							<td>
							...
							<td>
								<input type="file" name="video" value="<?php echo $Contenu['video']; ?>" id="video">
							</td>
						</tr>
						<tr>
							<td>
							...
							<td>
								<select name="categorie" id="categorie">
									<?php foreach ($categories as $categorie) : ?>
										<option value="<?php echo $categorie['id_categorie']; ?>"><?php echo $categorie['nom_categorie'];
																									echo " | ";
																									echo $categorie['niveau']; ?></option>
									<?php endforeach; ?>
								</select>
							</td>
						</tr>
						<tr>
							<td>
								<label for="image_path">Image de contenu:
								</label>
							</td>
		...
		<script>
			...
			document.getElementById("titre").addEventListener("input", function() {
				...
				if (verif_alphanumerique(text)) {
					...
					document.getElementById("titreMessage").textContent = ""; // Supprimez le message d'erreur
				} else {
			...
			// Fonction valideform() mise à jour
			function valideform() {
				var titre = document.getElementById("titre").value;
				var titreMessage = document.getElementById("titreMessage");


				// Vérifiez le titre et appliquez un style à la zone de texte et affichez le message d'alerte dans le span
				if (!verif_alphanumerique(titre)) {
					document.getElementById("titre").style.backgroundColor = "red";
					titreMessage.textContent = "Titre invalide";
					return false;
				} else {
