...
function validerFormulaire() {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (empty($_POST['titre']) || empty($_POST['entreprise']) || empty($_POST['type_stage']) || empty($_POST['duree']) || empty($_POST['domaine']) || empty($_POST['nombre_place']) || empty($_POST['description'])) {
            ...
            if ($duree <= 0) {
                $erreurs[] = "la duree doit être supérieur à 0.";
            } 
